...
if(isset($_POST['btn-submit']))
{
	...
	if(mysql_query("INSERT INTO `allergies`(`user`, `type`, `assessed`) VALUES ('$patientID','$allergy','$doctor')")){
		?>
               ...
               ?>	
					<div class="column_middle_grid1">
					 <div class="profile_picture" style="text-align:left;">
                        <h1 style="font-weight:600; font-size:18px;">Add Allergy</h1><br>
						<form method="post">
						  <input type="text" name="allergy" placeholder="Allergy"><br>
						  <input type="text" name="doctor" placeholder="Doctor">
						  <button style="margin-top:20px;" name="btn-submit">Add Allergy</button>
						</form>
						</div>
					 </div>
					 </div>							   
