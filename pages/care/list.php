...
if(isset($_POST['medication'])) {
    $profile = $_POST['medication'];
	$_SESSION['profile'] = $profile;
	?>
		<script>window.location.replace("add-medication.php");</script>
	<?php
}
?>
        <!-- page content -->
								...
								if($num_row) {
								   while($row = mysql_fetch_array($resultset)) { 
										...
										echo '<tr>
										  ...
										  <td><button type="submit" name="medication" value="',$patientID,'" class="btn btn-danger">Add Medication</button></td>
										</tr>';
								   }
								}
							  ?>
