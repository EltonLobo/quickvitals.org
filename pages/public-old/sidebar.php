            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-medkit"></i> Vitals <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a href="notes.php"><i class="fa fa-edit"></i> Notes</a>
                  </li>
                </ul>
              </div>
              </div>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Settings" href="edit-profile.php">
